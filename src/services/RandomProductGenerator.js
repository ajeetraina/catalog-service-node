...
// Product categories with associated templates
...
async function generateRandomProduct() {
  ...
  try {
    ...
    // In the future, you might want to generate or select a relevant image
    // For now, we'll create a dummy image if needed
